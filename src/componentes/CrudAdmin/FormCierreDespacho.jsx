...
import { BACK_DESPACHOS_URL } from "../../config/api";
...
export const FormCierreDespacho = ({ despacho, onClose }) => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      await axios.put(
        `http://a1173b045e3a24db4b5ee393b4bb0a72-1600190346.us-east-1.elb.amazonaws.com:8080/api/v1/despachos/${despacho.idDespacho}`,
        jsonData,
        {
          headers:{
